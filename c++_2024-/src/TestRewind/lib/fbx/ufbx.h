...
UFBX_LIST_TYPE(ufbx_float2_list, ufbx_float2);
UFBX_LIST_TYPE(ufbx_float3_list, ufbx_float3);
UFBX_LIST_TYPE(ufbx_float4_list, ufbx_float4);
...
typedef enum ufbx_prop_flags UFBX_FLAG_REPR {
	...
	// Value type.
	// `REAL/float2/float3/float4` are mutually exclusive but may coexist with eg. `STRING`
	// in some rare cases where the string defines the unit for the vector.
	UFBX_PROP_FLAG_VALUE_REAL = 0x100000,
	UFBX_PROP_FLAG_VALUE_float2 = 0x200000,
	UFBX_PROP_FLAG_VALUE_float3 = 0x400000,
	UFBX_PROP_FLAG_VALUE_float4 = 0x800000,
...
struct ufbx_prop {
	...
	union {
		...
		ufbx_float2 value_float2;
		ufbx_float3 value_float3;
		ufbx_float4 value_float4;
	};
};
...
struct ufbx_node {
	...
	ufbx_float3 adjust_pre_scale;     // < Scaling applied between parent and self
...
typedef struct ufbx_vertex_float2 {
	bool exists;
	ufbx_float2_list values;
	ufbx_uint32_list indices;
	size_t value_reals;
	bool unique_per_vertex;

	UFBX_VERTEX_ATTRIB_IMPL(ufbx_float2)
} ufbx_vertex_float2;

// 3D vertex attribute, see `ufbx_vertex_attrib` for information
typedef struct ufbx_vertex_float3 {
	bool exists;
	ufbx_float3_list values;
	ufbx_uint32_list indices;
	size_t value_reals;
	bool unique_per_vertex;

	UFBX_VERTEX_ATTRIB_IMPL(ufbx_float3)
} ufbx_vertex_float3;

// 4D vertex attribute, see `ufbx_vertex_attrib` for information
typedef struct ufbx_vertex_float4 {
	bool exists;
	ufbx_float4_list values;
	ufbx_uint32_list indices;
	size_t value_reals;
	bool unique_per_vertex;

	UFBX_VERTEX_ATTRIB_IMPL(ufbx_float4)
} ufbx_vertex_float4;
...
typedef struct ufbx_uv_set {
	...
	ufbx_vertex_float2 vertex_uv;        // < UV / texture coordinates
	ufbx_vertex_float3 vertex_tangent;   // < (optional) Tangent vector in UV.x direction
	ufbx_vertex_float3 vertex_bitangent; // < (optional) Tangent vector in UV.y direction
} ufbx_uv_set;
...
typedef struct ufbx_color_set {
	...
	// Vertex attributes, see `ufbx_mesh` attributes for more information
	ufbx_vertex_float4 vertex_color; // < Per-vertex RGBA color
} ufbx_color_set;
...
struct ufbx_mesh {
	...
	ufbx_vertex_float3 vertex_position;  // < Vertex positions
	ufbx_vertex_float3 vertex_normal;    // < (optional) Normal vectors (TODO: Generate?)
	ufbx_vertex_float2 vertex_uv;        // < (optional) UV / texture coordinates
	ufbx_vertex_float3 vertex_tangent;   // < (optional) Tangent vector in UV.x direction
	ufbx_vertex_float3 vertex_bitangent; // < (optional) Tangent vector in UV.y direction
	ufbx_vertex_float4 vertex_color;     // < (optional) Per-vertex RGBA color
	...
	ufbx_vertex_float3 skinned_position;
	ufbx_vertex_float3 skinned_normal;
...
struct ufbx_camera {
	...
	ufbx_float2 film_size_inch;      // < Film size in inches
	ufbx_float2 aperture_size_inch;  // < Aperture/film gate size in inches
...
struct ufbx_line_curve {
	...
	ufbx_float3_list control_points; // < List of possible values the line passes through
...
struct ufbx_nurbs_curve {
	...
	ufbx_float4_list control_points;
};
...
struct ufbx_blend_shape {
	...
	ufbx_float3_list position_offsets;  // < Always specified per-vertex offsets
	ufbx_float3_list normal_offsets;    // < Empty if not specified
};
...
typedef enum ufbx_cache_data_format UFBX_ENUM_REPR {
	...
	UFBX_CACHE_DATA_FORMAT_float3_FLOAT,  // < `struct { float x, y, z; } data[]`
	UFBX_CACHE_DATA_FORMAT_REAL_DOUBLE, // < `double data[]`
	UFBX_CACHE_DATA_FORMAT_float3_DOUBLE, // < `struct { double x, y, z; } data[]`

	UFBX_ENUM_FORCE_WIDTH(UFBX_CACHE_DATA_FORMAT)
} ufbx_cache_data_format;

UFBX_ENUM_TYPE(ufbx_cache_data_format, UFBX_CACHE_DATA_FORMAT, UFBX_CACHE_DATA_FORMAT_float3_DOUBLE);
...
struct ufbx_display_layer {
	...
	ufbx_float3 ui_color; // < Visual color for UI
};
...
typedef struct ufbx_curve_point {
	bool valid;
	ufbx_float3 position;
	ufbx_float3 derivative;
} ufbx_curve_point;

typedef struct ufbx_surface_point {
	bool valid;
	ufbx_float3 position;
	ufbx_float3 derivative_u;
	ufbx_float3 derivative_v;
} ufbx_surface_point;
...
extern const ufbx_float2 ufbx_zero_float2;
extern const ufbx_float3 ufbx_zero_float3;
extern const ufbx_float4 ufbx_zero_float4;
...
ufbx_abi ufbx_float3 ufbx_find_float3_len(const ufbx_props *props, const char *name, size_t name_len, ufbx_float3 def);
ufbx_inline ufbx_float3 ufbx_find_float3(const ufbx_props *props, const char *name, ufbx_float3 def) { return ufbx_find_float3_len(props, name, strlen(name), def); }
...
ufbx_abi ufbx_float2 ufbx_evaluate_anim_value_float2(const ufbx_anim_value *anim_value, double time);
ufbx_abi ufbx_float3 ufbx_evaluate_anim_value_float3(const ufbx_anim_value *anim_value, double time);
...
ufbx_abi ufbx_float3 ufbx_quat_rotate_float3(ufbx_quat q, ufbx_float3 v);
ufbx_abi ufbx_float3 ufbx_quat_to_euler(ufbx_quat q, ufbx_rotation_order order);
ufbx_abi ufbx_quat ufbx_euler_to_quat(ufbx_float3 v, ufbx_rotation_order order);
...
ufbx_abi ufbx_float3 ufbx_transform_position(const ufbx_matrix *m, ufbx_float3 v);
ufbx_abi ufbx_float3 ufbx_transform_direction(const ufbx_matrix *m, ufbx_float3 v);
...
ufbx_abi ufbx_float3 ufbx_get_blend_shape_vertex_offset(const ufbx_blend_shape *shape, size_t vertex);
ufbx_abi ufbx_float3 ufbx_get_blend_vertex_offset(const ufbx_blend_deformer *blend, size_t vertex);
...
ufbx_abi ufbx_float3 ufbx_catch_get_weighted_face_normal(ufbx_panic *panic, const ufbx_vertex_float3 *positions, ufbx_face face);
ufbx_inline ufbx_float3 ufbx_get_weighted_face_normal(const ufbx_vertex_float3 *positions, ufbx_face face) {
...
ufbx_abi void ufbx_catch_compute_normals(ufbx_panic *panic, const ufbx_mesh *mesh, const ufbx_vertex_float3 *positions,
	const uint32_t *normal_indices, size_t num_normal_indices,
	ufbx_float3 *normals, size_t num_normals);
ufbx_abi void ufbx_compute_normals(const ufbx_mesh *mesh, const ufbx_vertex_float3 *positions,
	const uint32_t *normal_indices, size_t num_normal_indices,
	ufbx_float3 *normals, size_t num_normals);
...
ufbx_abi size_t ufbx_read_geometry_cache_float3(const ufbx_cache_frame *frame, ufbx_float3 *data, size_t num_data, const ufbx_geometry_cache_data_opts *opts);
ufbx_abi size_t ufbx_sample_geometry_cache_float3(const ufbx_cache_channel *channel, double time, ufbx_float3 *data, size_t num_data, const ufbx_geometry_cache_data_opts *opts);
...
ufbx_inline ufbx_float2 ufbx_get_vertex_float2(const ufbx_vertex_float2 *v, size_t index) { ufbx_assert(index < v->indices.count); return v->values.data[(int32_t)v->indices.data[index]]; }
ufbx_inline ufbx_float3 ufbx_get_vertex_float3(const ufbx_vertex_float3 *v, size_t index) { ufbx_assert(index < v->indices.count); return v->values.data[(int32_t)v->indices.data[index]]; }
ufbx_inline ufbx_float4 ufbx_get_vertex_float4(const ufbx_vertex_float4 *v, size_t index) { ufbx_assert(index < v->indices.count); return v->values.data[(int32_t)v->indices.data[index]]; }
