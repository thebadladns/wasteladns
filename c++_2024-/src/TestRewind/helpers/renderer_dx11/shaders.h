...
constexpr VS_src vs_forward_base_float3Color4B_CBuffer_DebugScene_Standard = {
"forward_base_float3Color4B_CBuffer_DebugScene_Standard",
R"(
...
struct VS_src_selector<
    ...
    Layout_float3Color4B,
    Layout_CBuffer_DebugScene,
    VSDrawType::Standard> {
    static const VS_src& value() { return vs_forward_base_float3Color4B_CBuffer_DebugScene_Standard; }
};

template <>
struct VS_src_selector<
    VSTechnique::forward_base,
    Layout_float2Color4B,
    Layout_CBuffer_DebugScene,
    VSDrawType::Standard> {
    static const VS_src& value() { return vs_forward_base_float3Color4B_CBuffer_DebugScene_Standard; }
};

constexpr VS_src vs_forward_base_float3_CBuffer_3DScene_Sandard = {
"vs_forward_base_float3_CBuffer_3DScene_Sandard",
R"(
...
struct VS_src_selector<
    ...
    VSDrawType::Standard> {
    static const VS_src& value() { return vs_forward_base_float3_CBuffer_3DScene_Sandard; }
};

constexpr VS_src vs_forward_base_float3Color4B_CBuffer_3DScene_Standard = {
"forward_base_float3Color4B_CBuffer_3DScene_Standard",
R"(
cbuffer PerScene : register(b0) {
    matrix projectionMatrix;
    matrix viewMatrix;
...
struct VS_src_selector<
    ...
    Layout_CBuffer_3DScene,
    VSDrawType::Standard> {
    static const VS_src& value() { return vs_forward_base_float3Color4B_CBuffer_3DScene_Standard; }
};


constexpr VS_src vs_forward_base_float3Color4BSkinned_CBuffer_3DScene_Standard = {
"forward_base_float3Color4BSkinned_CBuffer_3DScene_Standard",
R"(
cbuffer PerScene : register(b0) {
    matrix projectionMatrix;
    matrix viewMatrix;
...
struct VS_src_selector<
    VSTechnique::forward_base,
    Layout_float3Color4BSkinned,
    Layout_CBuffer_3DScene,
    VSDrawType::Standard> {
    static const VS_src& value() { return vs_forward_base_float3Color4BSkinned_CBuffer_3DScene_Standard; }
};

constexpr VS_src vs_forward_base_float3_CBuffer_3DScene_Instanced = {
"forward_base_float3_CBuffer_3DScene_Instanced"
, R"(
cbuffer PerScene : register(b0) {
    matrix projectionMatrix;
    matrix viewMatrix;
...
struct VS_src_selector<
    ...
    static const VS_src& value() { return vs_forward_base_float3_CBuffer_3DScene_Instanced; }
};
constexpr VS_src vs_forward_base_Texturedfloat3_CBuffer_3DScene_Standard = {
"forward_base_Texturedfloat3_CBuffer_3DScene_Standard",
R"(
cbuffer PerScene : register(b0) {
    matrix projectionMatrix;
    matrix viewMatrix;
...
struct VS_src_selector<
    VSTechnique::forward_base,
    Layout_Texturedfloat3,
    Layout_CBuffer_3DScene,
    VSDrawType::Standard> {
    static const VS_src& value() { return vs_forward_base_Texturedfloat3_CBuffer_3DScene_Standard; }
};

// TODO: REWRITE
constexpr VS_src vs_forward_base_TexturedSkinnedfloat3_CBuffer_3DScene_Standard = {
"forward_base_TexturedSkinnedfloat3_CBuffer_3DScene_Standard",
R"(
cbuffer PerScene : register(b0) {
    matrix projectionMatrix;
    matrix viewMatrix;
...
struct VS_src_selector<
    VSTechnique::forward_base,
    Layout_TexturedSkinnedfloat3,
    Layout_CBuffer_3DScene,
    VSDrawType::Standard> {
    static const VS_src& value() { return vs_forward_base_TexturedSkinnedfloat3_CBuffer_3DScene_Standard; }
};

constexpr VS_src vs_forward_base_Layout_float3TexturedMapped_CBuffer_3DScene_Standard = {
"forward_base_Layout_float3TexturedMapped_CBuffer_3DScene_Standard",
R"(
cbuffer PerScene : register(b0) {
    matrix projectionMatrix;
    matrix viewMatrix;
...
struct VS_src_selector<
    VSTechnique::forward_base,
    Layout_float3TexturedMapped,
    Layout_CBuffer_3DScene,
    VSDrawType::Standard> {
    static const VS_src& value() { return vs_forward_base_Layout_float3TexturedMapped_CBuffer_3DScene_Standard; }
};
...
constexpr PS_src ps_forward_textured_unlit_Texturedfloat3_CBuffer_3DScene = {
"forward_textured_unlit_Texturedfloat3_CBuffer_3DScene",
...
struct PS_src_selector<
    ...
    static const PS_src& value() { return ps_forward_textured_unlit_Texturedfloat3_CBuffer_3DScene; }
};
template <>
struct PS_src_selector<
    PSTechnique::forward_textured_unlit,
...
constexpr PS_src ps_forward_textured_unlitalphaclip_Texturedfloat3_CBuffer_3DScene = {
"forward_textured_unlitalphaclip_Texturedfloat3_CBuffer_3DScene",
textured_unlit_samplers,
sizeof(textured_unlit_samplers) / sizeof(textured_unlit_samplers[0]),
R"(
cbuffer PerScene : register(b0) {
...
struct PS_src_selector<
    ...
    Layout_CNone> {
    enum { materialUsage = PSMaterialUsage::Uses };
    static const PS_src& value() { return ps_forward_textured_unlitalphaclip_Texturedfloat3_CBuffer_3DScene; }
};
template <>
struct PS_src_selector<
    PSTechnique::forward_textured_unlitalphaclip,
...
constexpr PS_src ps_forward_textured_lit_normalmapped_Layout_float3TexturedMapped_CBuffer_3DScene = {
"forward_textured_lit_normalmapped_Layout_float3TexturedMapped_CBuffer_3DScene",
...
struct PS_src_selector<
    ...
    Layout_CBuffer_3DScene> {
    enum { materialUsage = PSMaterialUsage::Uses };
    static const PS_src& value() { return ps_forward_textured_lit_normalmapped_Layout_float3TexturedMapped_CBuffer_3DScene; }
};
