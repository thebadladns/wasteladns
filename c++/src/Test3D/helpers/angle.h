...
template <typename _T> const _T halfpi;
...
template <> const f32 halfpi<f32> = 1.57079637050628662109375;
template <> const f64 halfpi<f64> = 1.57079632679489655799898173427;
...
template <typename _T> _T asin(const _T v);

template <> f32 asin(const f32 v) {
    return ::asinf(v);
}
template <> f64 asin(const f64 v) {
    return ::asin(v);
}
